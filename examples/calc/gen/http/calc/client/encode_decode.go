...
func EncodeAddedRequest(encoder func(*http.Request) goahttp.Encoder) func(*http.Request, interface{}) error {
	return func(req *http.Request, v interface{}) error {
		p, ok := v.(*calcsvc.AddedPayload)
		if !ok {
			return goahttp.ErrInvalidType("calc", "added", "*calcsvc.AddedPayload", v)
		}
		body := NewAddedRequestBody(p)
		if err := encoder(req).Encode(&body); err != nil {
			return goahttp.ErrEncodingError("calc", "added", err)
		}
		return nil
	}
}
